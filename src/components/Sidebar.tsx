...
const ModuleIcon: React.FC<{ iconKey: string; className: string }> = memo(({ iconKey, className }) => {
...
const NavItem: React.FC<{ module: Module; collapsed: boolean }> = memo(({ module, collapsed }) => {
...
const Sidebar: React.FC<SidebarProps> = ({ onLogout, municipality, onChangeMunicipality, modules, isLoading = false }) => {
    ...
    // Agrupamento dinâmico memorizado
