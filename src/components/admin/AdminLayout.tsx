...
const AdminLayout: React.FC<AdminLayoutProps> = ({ onLogout, onImpersonate, currentUser }) => {
    ...
    // Mapeamento estendido para títulos
    const titles: Record<string, string> = {
        ...adminViewTitles,
        updates: 'Gerenciador de Atualizações',
        themes: 'Temas e Aparência'
    };
    const title = titles[currentView] || 'Gerenciamento';
    ...
    return (
        <div className="flex h-screen bg-brand-primary text-brand-text font-sans">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                 <header className="bg-brand-secondary p-4 shadow-md border-b border-brand-accent/20">
                ...
                <main className="flex-1 overflow-x-hidden overflow-y-auto bg-brand-primary p-4 md:p-6 lg:p-8 animate-fade-in-up">
                   <Routes>
                        ...
                        <Route path="themes" element={<ThemeManager showToast={showToast} />} />
