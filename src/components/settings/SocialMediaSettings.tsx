...
const SocialMediaSettings: React.FC = () => {
    ...
    return (
        <ModuleSettingsLayout moduleName="Módulo de Monitoramento de Redes Sociais" onSave={handleSave} isSaving={isSaving}>
            <div className="bg-brand-primary p-4 rounded-lg">
                ...
                <textarea 
                    ...
                    placeholder="Ex: Monitore as principais plataformas e analise o sentimento considerando ironia..."
                />
            </div>
