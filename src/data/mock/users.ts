...
export const initialUsers: User[] = [
    ...
    { id: 2, username: 'jornalista1', password: '123', email: 'jornal@media.com', role: 'user', status: 'Ativo', planId: 'enterprise', planExpiration: '2025-12-31', canUseOwnApiKey: true, usage: 0, avatarUrl: '' },
